  ...
  var BRANDS = {
    ...
    amazon: {
      ...
      stops: [
        ...
        stop("2005", "sites/amazon/index.html", "Upload year"),
    ...
    google: {
      ...
      stops: [
        ...
        stop("2005", "sites/google/index.html", "Maps leftover"),
    ...
    facebook: {
      ...
      stops: [
        ...
        stop("2005", "sites/facebook/index.html", "rename era"),
        ...
        stop("2019", "sites/facebook/index.html", "Continue year"),

        stop("2021", "sites/facebook/index.html", "ATT year"),
        stop("2022", "sites/facebook/index.html", "ChatGPT year")
      ]
    },
    youtube: {
      label: "YouTube",
      match: /\/sites\/youtube\//,
      stops: [
        stop("2005", "sites/youtube/upload.html", "independent upload"),
        ...
        stop("2016", "sites/youtube/index.html", "Stories year"),
        stop("2017", "sites/youtube/index.html", "Face ID year"),
        stop("2018", "sites/youtube/index.html", "GDPR year"),
        stop("2019", "sites/youtube/index.html", "Continue year"),

        stop("2021", "sites/youtube/index.html", "ATT year"),
        stop("2022", "sites/youtube/index.html", "ChatGPT year")
      ]
    },
    twitter: {
      label: "Twitter",
    ...
    instagram: {
      ...
      stops: [
        ...
        stop("2017", "sites/instagram/index.html", "Face ID year"),
    ...
    iphone: {
      ...
      stops: [
        ...
        stop("2016", "sites/iphone/index.html", "iPhone 7"),
