...
(function (global) {
  ...
  var rooms = [
    ...
    "sites/googlewave/index.html",
    "sites/friendfeed09/index.html",
    "sites/android09/index.html",
    "sites/chrome09/index.html",
    "sites/spotifyeu/index.html",
    "sites/dropbox09/index.html",
  ...
  ITT.configs["2009"] = {
    ...
    locationHints: [
      { re: /google.?wave|\bwave\b/i, path: "sites/googlewave/index.html" },
      { re: /friend.?feed/i, path: "sites/friendfeed09/index.html" },
      { re: /android/i, path: "sites/android09/index.html" },
      { re: /\bchrome\b/i, path: "sites/chrome09/index.html" },
      { re: /spotify/i, path: "sites/spotifyeu/index.html" },
      { re: /dropbox/i, path: "sites/dropbox09/index.html" },
