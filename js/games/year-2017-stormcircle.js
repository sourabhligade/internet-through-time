/**
 * Storm Circle — 2017 museum year game (Fortnite-class storm, original).
 * Walk · loot silhouettes · stay inside the shrinking storm.
 * Storage: itt17-game-stormcircle via YearGame.saveBest
 * No official Fortnite/Nintendo art · no real GPS · slither.io is 2017 but not this game.
 */
(function () {
  "use strict";
  var YG = (window.ITT && ITT.YearGame) || null;
  var host = document.querySelector('[data-year-game][data-game-id="stormcircle"]');
  if (!host) return;
  ...
  function paintBest() {
    if (bestEl) bestEl.textContent = String(YG ? YG.loadBest("stormcircle", "2017") : 0);
  }
  ...
  host.__ittStormCircleEnd = function (n) {
  ...
  host.__ittGymRushEnd = host.__ittStormCircleEnd;
  host.__ittStormCircleVisit = function (n) {
    var i;
