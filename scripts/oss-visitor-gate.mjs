...
try {
  // --- Hub ---
  {
    ...
    else ok("hub-cards", `${YEARS.length} playable years (1994–2019 + 2021 · 2005–2007 / 2009 / 2011 / 2020 / 2022–2025 wiped)`);
    const copy = await page.locator("body").innerText();
    if (!/22 years open/i.test(copy)) fail("hub-copy", "expected 22 years open");
    else ok("hub-copy");
