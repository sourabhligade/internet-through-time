...
const WIPED = new Set(["2007", "2009", "2011", "2020", "2022", "2023", "2024", "2025"]);
const YEARS = [];
...
try {
  // --- Hub ---
  {
    ...
    else ok("hub-cards", `${YEARS.length} playable years (1994–2006 + 2008 + 2010 + 2012–2019 + 2021 · 2007 / 2009 / 2011 / 2020 / 2022–2025 boarded)`);
    const copy = await page.locator("body").innerText();
    if (!/24 years open/i.test(copy)) fail("hub-copy", "expected 24 years open");
    else ok("hub-copy");
