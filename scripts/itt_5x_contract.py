...
WIPED_YEARS: frozenset[int] = frozenset({2003, 2005, 2006, 2007, 2009, 2011, 2020, 2021, 2022, 2023, 2024, 2025})
...
FAMOUS_YEARS = [
    ...
    if y not in {2001, 2002, 2003, 2005, 2006, 2007, 2009, 2011, 2013, 2014}
]
