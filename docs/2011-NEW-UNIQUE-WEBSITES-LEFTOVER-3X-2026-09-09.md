...
```mermaid
flowchart TD
  pew[Pew: search + email still #1] --> mass[KEEP MASS 22]
  cs[comScore U.S. 2011] --> mass
  ping[Pingdom 2011 numbers] --> beat[YEAR-BEAT 12]
  time[TIME 50 Aug 2011] --> thin[THIN 22]
  mass --> nofarm[0 folders until dest-farm lifted]
  beat --> nofarm
  thin --> nofarm
  seed[SEED / HONESTY] -.-> nofarm
```
