...
| Layer | Requirement |
|-------|-------------|
| **A Story** | Thesis on home + About · dual-cite scale when late years · hard bans listed |
| **B Densify** | P0 multipage or multipath rooms · connection trails on home · real localStorage on signature actions |
...
| Extra | 2007–2010 | 2011–2012 target |
|-------|-----------|------------------|
| densify.spec | yes | **yes** |
| trail-real-flows.spec | yes | **yes** |
| Minute research pack | optional | yes |

## Residual forever (does not block museum-ready)

- Perfect WA logo for every brand  
