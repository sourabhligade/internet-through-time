...
|----|--------|----------------------|------|--------|
| H11-01 | Spotify US marketing hero | WA spotify.com **201107–201109** | `assets/period/2011/spotify/hero-wa.*` | **queued** |
| H11-02 | Spotify logo / green mark | WA or WDM evolution | `spotify/logo-wa.*` | **queued** |
| H11-03 | Facebook 2011 blue bar / logo | WA facebook.com **201109** · WDM | `facebook/logo-wa.*` | **queued** |
| H11-04 | Facebook Timeline two-column | Version Museum source · WA profile class | `facebook/timeline-wa.*` | **queued** |
| H11-05 | Google+ logo + Circles UI | WA plus.google.com **201107+** | `googleplus/*` | **queued** |
| H11-06 | iPhone 4S product hero | Apple Newsroom · images.apple.com WA **201110** | `iphone/4s-hero-wa.*` | **queued** |
| H11-07 | Siri UI still | Period hands-on · Apple feature page WA | `iphone/siri-wa.*` | **queued** |
| H11-08 | iPad 2 product hero | Apple Newsroom · WA apple.com/ipad **201103** | `ipad/ipad2-hero-wa.*` | **queued** |
| H11-09 | IE 9 chrome / download | WA windows.microsoft.com/ie9 **201103** | `ie9/*` | **queued** |
| H11-10 | Netflix 2011 browse / logo | WA netflix.com **201107** | `netflix/*` | **queued** |
| H11-11 | Snapchat early UI | Sparse — document failed-final if needed | `snapchat/*` | **queued** |
| H11-12 | Galaxy Nexus / ICS launcher | Google/Samsung PR · WA | `android/ics-wa.*` | **queued** |
| H11-13 | Instagram 2011 iOS | Continuity 2010 + WA instagr.am | `instagram/*` | **queued** |
