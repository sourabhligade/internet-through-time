...
**2021 is when the phone asks not to track — ATT Ask is the save, Allow never writes, Signal / Copilot waitlist / Meta rename are leftover, the mass shell is still Win10 + Chrome habit, ILS June 2021 websites does not exist, and ChatGPT / Wordle mass are next years.**
...
|------|-------|
| Prefix | `itt21-*` only |
| Shell | **Win10 + Chrome habit** · ATT is a **room** |
| ★ Star | **Ask App Not to Track** · `sites/att/index.html` · `itt21-att` · Ask writes · Allow never writes |
| Incomplete | Allow · empty · 0 ticks · ChatGPT · never writes |
| Complete | Ask + honesty · `{official:true, year:"2021"}` |
...
| ITU 2021 | **4.9 billion users / 63%** |
| ATT | iOS 14.5 · April 2021 leftover · Ask writes · Allow never writes |
| Signal delay | **15 May 2021** leftover |
| Copilot | waitlist leftover · **not ChatGPT** |
| Meta | **28 Oct 2021** rename leftover · app still Facebook |
| Windows 11 | leftover · not January OS |
| Flash | end of Flash leftover |

## Bans

**dest-farm · 5,000 dests · ChatGPT dest · Wordle-as-2021-mass · invent June ILS 2021 websites · 300M Zoom users · leftover writes `itt21-att` · leftover-4× · 7th guided `<li>` · Meta-as-gold · leftover-2× as double dest folders.**
