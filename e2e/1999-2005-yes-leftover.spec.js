// @ts-check
/**
 * YES famous dests that are not leftover-3× doors.
 * Dest-true leftover machine · empty/trap never write · complete leftover only.
 */
const { test, expect } = require("@playwright/test");
const ROWS = require("./1999-2005-yes-leftover.matrix.json");
