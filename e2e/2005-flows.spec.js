...
test.describe("2005 flows", () => {
  ...
  test("gold dest loads", async ({ page }) => {
    const res = await page.goto("/years/2005/sites/youtube/upload.html");
    expect(res && res.ok()).toBeTruthy();
    await expect(page.locator("html")).toHaveAttribute("data-itt-year", "2005");
  });

  test("map lists official 10", async ({ page }) => {
    await page.goto("/years/2005/pages/map.html");
