...
test("2021 Signal leftover 4× never writes itt21-att", async ({ page }) => {
  await leftover4x(page, "/years/2021/sites/signal/index.html", "sig-lx-4x", "itt21-sig-lx-4x", "itt21-att");
});

test("2021 Win11 leftover 4× never writes itt21-att", async ({ page }) => {
  await leftover4x(page, "/years/2021/sites/windows11/index.html", "win11-lx-4x", "itt21-win11-lx-4x", "itt21-att");
});
