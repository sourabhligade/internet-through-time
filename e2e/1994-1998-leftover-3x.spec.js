// @ts-check
/**
 * Leftover-3× ×3 for 1994–1998 — dest-true · not mock. Gold dest never leftover-3×.
 */
const { test, expect } = require("@playwright/test");
const { revealLeftoverRails } = require("./helpers");
const ROWS = require("./1994-1998-leftover-3x.matrix.json");

const WANT = {
  1994: { first: 9, more: 9, third: 9 },
  1995: { first: 9, more: 9, third: 9 },
  1996: { first: 9, more: 9, third: 9 },
  1997: { first: 9, more: 9, third: 9 },
  1998: { first: 9, more: 9, third: 9 },
};
...
test.describe("1994–1998 leftover-3× ×3 home strips", () => {
