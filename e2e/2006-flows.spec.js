...
test.describe("2006 flows", () => {
  ...
  test("gold dest loads", async ({ page }) => {
    const res = await page.goto("/years/2006/sites/twitter/index.html");
    expect(res && res.ok()).toBeTruthy();
    await expect(page.locator("html")).toHaveAttribute("data-itt-year", "2006");
  });
