...
test.describe('hub + year shells', () => {
  ...
  test('passport treats 2020 live and 2021–2025 wiped', async ({ page }) => {
    ...
    expect(live.trails).toEqual(expect.arrayContaining(['2020-start']));
    expect(live.trails).not.toEqual(expect.arrayContaining(['2021-start', '2022-start', '2023-start', '2024-start', '2025-start']));
  });
  ...
  test('resume works for every open year including lean doors', async ({ page }) => {
    const lean = ['2007', '2009', '2011', '2013', '2014', '2016', '2017', '2018', '2019', '2020'];
    for (const y of lean) {
      await page.goto('/');
    ...
    for (const wiped of ['2021', '2022', '2023', '2024', '2025']) {
