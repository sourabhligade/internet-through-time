...
Historical reconstruction of the World Wide Web — year by year. Hub **31 years open** (1994–2024). **2025** is boarded. 2001 star = Wikipedia UseMod. 2002 star = StumbleUpon. 2003 star = Photobucket upload. 2005 star = YouTube upload. 2006 star = Twttr. 2007 star = iPhone Safari. 2009 star = Facebook Like. 2011 star = Google+ Hangout. 2019 star = Disney+ Continue. 2020 star = Zoom Leave. 2021 star = ATT Ask. 2022 star = ChatGPT Send. 2023 star = Plus Subscribe. 2024 star = GPT-4o Talk.
...
| `/years/2007/` | Lean door — iPhone Safari `itt07-iphone` · leftover 2× 120 · XP+IE6 |
| `/years/2008/` | App Store · iPhone 3G · Chrome · Android G1 · Hulu · **ship** |
| `/years/2009/` | Lean door — Facebook Like `itt09-like` · leftover 2× 120 · XP+IE8 |
| `/years/2010/` | Win7 · IE 8 · iPad · iPhone 4 · Instagram iOS · Open Graph · **lean** |
| `/years/2011/` | Lean door — Google+ Hangout `itt11-gplus` · leftover 2× 120 · Win7+IE9 |
...
| `/years/2020/` | Lean door — Zoom Leave `itt20-zoom` · leftover 2× 120 · Win10 + Chrome habit |
| `/years/2021/` | Lean door — ATT Ask `itt21-att` · leftover 2× 120 |
| `/years/2022/` | Lean door — ChatGPT Send `itt22-chatgpt` · leftover 2× 120 |
| `/years/2023/` | Lean door — Plus Subscribe `itt23-plus` · leftover 2× 120 · dest name X |
| `/years/2024/` | Lean door — GPT-4o Talk `itt24-gpt4o` · leftover 2× 120 |
| `/years/2025/` | **Boarded** — hub locked · no year tree |
| `/games/` | Period web games wing (portals · Club Penguin culture · museum JS arcade) |

**Lean doors:** 2007 + 2009 + 2011 + 2013–2024. Hub is **31 years open** (1994–2024). **2025 is boarded.** 2001–2003 are cut-forest live. 2019 is Disney+ Continue. 2021 is ATT Ask. 2022 is ChatGPT Send. 2023 is Plus Subscribe. 2024 is GPT-4o Talk.
