...
| `/years/2020/` | **Wiped** — no tree |
| `/years/2021/` | **Live lean door** — ATT Ask `itt21-att` · leftover dest faces |
| `/years/2022/` | **Live lean door** — ChatGPT Send `itt22-chatgpt` · 45 dests |
| `/games/` | Period web games wing (portals · Club Penguin culture · museum JS arcade) |

**Lean doors:** 2007 + 2011 + 2013–2019 + 2021–2022. Hub is **27 years open** (1994–2008 + 2010–2019 + 2021–2022). **2009 boarded.** **2020 wiped.** **2023+ wiped.** 2013 star = Vine 6s. 2018 star = GDPR Manage. 2019 star = Disney+ Continue. 2021 star = ATT Ask. 2022 star = ChatGPT Send.
